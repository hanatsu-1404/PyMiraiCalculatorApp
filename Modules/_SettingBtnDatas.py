def SetBtnData(self):
    self.AllBtnData = {
        ...
        "sinx":self.BtnData("sinx",lambda:self.InsCmd("sin(","arcsin("),"arcsinx"),
        "cosx":self.BtnData("cosx",lambda:self.InsCmd("cos(","arccos("),"arccosx"),
        "tanx":self.BtnData("tanx",lambda:self.InsCmd("tan(","arctan("),"arctanx"),
        "√x":self.BtnData("√x",lambda:self.InsCmd("^(1/2)")),
        "x^2":self.BtnData("x^2",lambda:self.InsCmd("^2","^(1/2)"),"x^(1/2)"),
        "x^y":self.BtnData("x^y",lambda:self.InsCmd("^(","^(1/("),"x^(1/y)"),
        "log_a(x)":self.BtnData("log_a(x)",lambda:self.InsCmd("log((e),(","10^("),"10^x"),
        "π":self.BtnData("π",lambda:self.InsCmd("π","factorial("),"n!"),
